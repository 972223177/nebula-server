...
| T04 | `service/.../conversation/ConversationServiceTest.kt` | 全文 | 缺少 memberCount 并发更新测试 |
| T05 | `service/.../admin/DeadLetterServiceTest.kt` | 全文 | 缺少 payload 补偿路径测试 |
| T06 | `service/.../sequence/SeqServiceTest.kt` | 全文 | 缺少 Redis 重启恢复测试 |
