...
class PrivacySmokeTest {
    ...
    fun fullFlowShouldHideThenVerify() = runTest {
        ...
        // ---- 步骤 2: 读取确认 ----
        coEvery { userPrivacyService.getPrivacySettings(any()) } returns GetPrivacyResp.newBuilder().setHideOnlineStatus(true).build()
    ...
    fun fullFlowShouldShowThenVerify() = runTest {
        ...
        // ---- 步骤 2: 读取确认 ----
        coEvery { userPrivacyService.getPrivacySettings(any()) } returns GetPrivacyResp.newBuilder().setHideOnlineStatus(false).build()
